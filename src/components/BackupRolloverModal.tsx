...
export const BackupRolloverModal: React.FC<BackupRolloverModalProps> = ({
  ...
  useEffect(() => {
    if (isOpen) {
      const localArchives = getStoredSnapshots(session.schoolId || 'eminent-academy');
      ...
      getTermBackupsFromFirestore(session.schoolId || 'eminent-academy')
        .then((remoteBackups) => {
  ...
  const handleCreateInstantSnapshot = () => {
    ...
    saveTermBackupToFirestore(snap, session.schoolId || 'eminent-academy').catch((err) =>
  ...
  const handleDeleteSnapshot = (id: string) => {
    deleteStoredSnapshot(id, session.schoolId || 'eminent-academy');
    deleteTermBackupFromFirestore(id, session.schoolId || 'eminent-academy').catch((err) =>
