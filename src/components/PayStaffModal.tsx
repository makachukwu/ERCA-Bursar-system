...
export const PayStaffModal: React.FC<PayStaffModalProps> = ({
  ...
  const schoolName = school?.name || session.schoolName || 'Eminent Royal Crown Academy';
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-3 sm:p-4 overflow-y-auto animate-in fade-in duration-200">
      <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl border border-slate-200 flex flex-col max-h-[92vh] overflow-hidden">
