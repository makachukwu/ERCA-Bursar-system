...
export const DEFAULT_USERS: Record<UserRole, SystemUserAccount> = {
  ...
  bursar: {
    ...
    email: 'bursar@eminent.academy',
    updatedAt: new Date().toISOString(),
  },
};

function getStorageKey(schoolId: string = 'eminent-academy'): string {
 ...
 */
export function getStoredSystemUsers(schoolId: string = 'eminent-academy'): Record<UserRole, SystemUserAccount> {
